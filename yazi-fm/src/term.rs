...
impl Term {
    ...
    if TMUX.get() {
        ...
        execute!(
            TTY.writer(),
            Print(Mux::csi("\x1b[0c")), // Request device attributes (required)
        ...
        let _resp = Emulator::read_until_da1();
        Mux::tmux_drain()?;
        ...
        execute!(
            ...
            Print(Mux::csi("\x1b[?12$p")), // Request cursor blink status
